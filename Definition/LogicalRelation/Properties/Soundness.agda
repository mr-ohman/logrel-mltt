...
soundnessTermEq : ∀ {l Γ A t u} → ([A] : Γ ⊩⟨ l ⟩ A)
                → Γ ⊩⟨ l ⟩ t ≡ u ∷ A / [A]
                → Γ ⊢ t ≡ u ∷ A
soundnessTermEq (U (U l' l< ⊢Γ)) U[ ⊢t , ⊢u , t≡u , ⊩t , ⊩u , [t≡u] ] = t≡u
soundnessTermEq (ℕ (ℕ D)) ℕ≡[ k , k' , d , d' , t≡u , [k≡k'] , prop ] =
