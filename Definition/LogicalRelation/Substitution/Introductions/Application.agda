...
app-congTerm' : ∀ {F G t t' u u' Γ l l'}
          ...
          ([u≡u'] : Γ ⊩⟨ l' ⟩ u ≡ u' ∷ F / [F])
        → Γ ⊩⟨ l' ⟩ t ∘ u ≡ t' ∘ u' ∷ G [ u ] / [G[u]]
app-congTerm' [F] [G[u]] (noemb (Π F G D ⊢F ⊢G [F]₁ [G] G-ext)) (proj₁ , proj₂ , (proj₃ , proj₄ , proj₅) , proj₆) [u] [u'] [u≡u'] =
  let F≡F' , G≡G' = Π-PE-injectivity (whnfRed*' (red D) Π)
...
app-congTerm' [F] [G[u]] (emb 0<1 x) [t≡t'] [u] [u'] [u≡u'] = app-congTerm' [F] [G[u]] x [t≡t'] [u] [u'] [u≡u']
