...
data Tactic Γ : ∀ l l' A B (p : Γ ⊩⟨ l ⟩ A) (q : Γ ⊩⟨ l' ⟩ B) → Set where
  ...
  U : Tactic Γ ¹ ¹ U U (U {l< = 0<1}) (U {l< = 0<1})
...
goodCases {⁰} {l} (U {l< = ()}) U A≡B
goodCases {l} {⁰} U (U {l< = ()}) A≡B
goodCases {¹} {¹} (U {l< = 0<1}) (U {l< = 0<1}) A≡B = U
goodCases U (ℕ D) PE.refl = ⊥-elim (U≢ℕ (whnfRed*' (red D) U))
goodCases U (ne D neK) PE.refl = ⊥-elim (U≢ne neK (whnfRed*' (red D) U))
goodCases U (Π D ⊢F ⊢G [F] [G] G-ext) PE.refl = ⊥-elim (U≢Π (whnfRed*' (red D) U))
goodCases (ℕ D) U A≡B = ⊥-elim (U≢ℕ (whnfRed*' A≡B U))
...
goodCases (ne D neK) U ne[ M , D' , neM , K≡M ] = ⊥-elim (U≢ne neM (whnfRed*' (red D') U))
...
goodCases (Π D ⊢F ⊢G [F] [G] G-ext) U Π¹[ F' , G' , D' , A≡B , [F≡F'] , [G≡G'] ] = ⊥-elim (U≢Π (whnfRed*' D' U))
