...
mutual
  ...
  transConv↓Term A≡B (η-eq x x₁ x₂ y y₁ x₃) (Unit-ins _) = ⊥-elim (WF.Unit≢Bⱼ BΠ (sym A≡B))
  transConv↓Term A≡B (η-eq x x₁ x₂ y y₁ x₃) (η-unit _ _ _ _) = ⊥-elim (WF.Unit≢Bⱼ BΠ (sym A≡B))
